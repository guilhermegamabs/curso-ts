...
var errorMessage = 'show-error-message';
...
function showErrorMessage(input, msg) {
    ...
    var error_Message = formFields.querySelector('.error-message');
...
function hideErrorMessages(form) {
    form
        ...
        .forEach(function (item) { return item.classList.remove(errorMessage); });
}
...
function shouldSendForm(form) {
    var send = true;
    form.querySelectorAll('.' + errorMessage).forEach(function () { return (send = false); });
    return send;
}
